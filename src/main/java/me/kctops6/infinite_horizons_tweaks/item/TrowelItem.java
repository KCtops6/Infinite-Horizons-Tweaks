...
public class TrowelItem extends DiggerItem {
    ...
    public TrowelItem(Tier tier, float attackDamage, float attackSpeed, Properties properties) {
    ...
    public boolean isCorrectToolForDrops(ItemStack stack, BlockState state) {
        ...
        return state.is(BlockTags.MINEABLE_WITH_SHOVEL) && TierSortingRegistry.isCorrectTierForDrops(this.getTier(), state);
    }
}